...
const RandomeFour = ({ data, changeVideo }) => {
    return (
        <div className='grid grid-cols-2 gap-1' >
            {data.map((list, i) => (
                <div className="relative h-[110px] bg-youtube" style={{ backgroundImage: `url(https://img.youtube.com/vi/${list?.blog_image[0]?.details}/hqdefault.jpg)` }}  key={i} onClick={() => changeVideo(list)}>
